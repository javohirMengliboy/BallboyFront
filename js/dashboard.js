...
// addUser.addEventListener('click', getLast10User);
...
let articleTableBody = document.getElementById("article_list_table_body");
    ...
    fetch("http://localhost:8080/api/v1/article/open/getLast10Article", {method: "GET"})
        ...
        .then (data => {
            ...
            object.map((i) => {
                ...
                articleTableBody.append(rowElement)
            })
        })
        .catch(error => {
            console.log(error)
